<template>
  <b-input-group-append>
      ...
      <b-modal id="modal-1" size="lg" @ok="submit" title="競技マスタ選択">
        <b-card>
          <!-- User Interface controls -->
          <b-row>
            <b-col lg="6" class="my-1">
              <b-form-group label="Filter" label-cols-sm="3" label-for="filterInput">
                <b-input-group>
            ...
            <b-col sm="5" md="6" class="my-1">
              <b-form-group label="Per page" label-cols-sm="6" label-cols-md="4" label-cols-lg="3" label-for="perPageSelect">
